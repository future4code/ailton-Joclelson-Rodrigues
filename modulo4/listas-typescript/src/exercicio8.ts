const checaRenovacaoRG = (dataNascimento: string, dataDocumento: string): boolean | string => {
    ...
    const dataDocTimestamp: number = new Date(`${anoDoc}-${mesDoc}-${diaDoc}T00:00:00`).getTime();
  ...
  console.log(checaRenovacaoRG("11/07/1992", "20/09/2016"))